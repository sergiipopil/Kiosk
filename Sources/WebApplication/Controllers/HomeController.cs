...
namespace WebApplication.Controllers
{
    ...
    public class HomeController : Controller
    {
        ...
        public IActionResult ShowCategoryAutoParts(string carManufactureName, string carModel)
        {
            ...
            string tempKioskId = String.IsNullOrEmpty(HttpContext.Session.GetString("kioskId")) ? "116" : HttpContext.Session.GetString("kioskId");
            return View("_AutoPartsTree", new RightTreeViewModel() { ProductCategoryList = autoParts, ManufacturerSelected = carManufactureName, ModelSelected = carModel, kioskId=tempKioskId });
        }
        ...
        public IActionResult ShowMainSubChildsCategories(string carManufactureName, string carModel, string mainCategoryId, string mainCategoryName, string subCategoryId, string subCategoryName)
        {
            ...
            if (autoPartsSubChildCategories == null)
            {
                ...
                RightTreeViewModel treeViewModel = new RightTreeViewModel()
                {
                    ...
                    PageNumber = 1,
                    FunctionReturnFromProducts = String.Format("selectMainCategory('{0}', '{1}', '{2}', '{3}', '{4}')", carManufactureName, carModel, mainCategoryId, mainCategoryName, tempKioskId),
        ...
        public string GetFilterName(string categoryId) {
            ...
            IList<string> engineType = new List<string>() { "50825", "50828", "256143", "50831", "50829", "50830", "261131", "261131", "255442", "255441", "255440", "261150", "50824", "255451", "255447", "261133", 
            ...
            "256016", "50873", "256012", "260912", "256011", "256013", "260898", "260913", "260907", "256014", "256017", "260899", "260900", "260914", "260915", "256015", "256010", "256018", "260909", "50872", "260901", "50868", "50867",
